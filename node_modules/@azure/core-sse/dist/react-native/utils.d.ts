import type { NodeIncomingMessage } from "./types-react-native.mjs";
...
export declare function ensureAsyncIterable(stream: NodeIncomingMessage | NodeJSReadableStream | ReadableStream<Uint8Array>): {
    cancel(): Promise<void>;
